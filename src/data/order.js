 ...
 * parsed line items with the AI layer's candidate matches.
 *
...
export const emailThread = {
  ...
  to: [{ name: 'Meridian Orders', email: 'orders@meridian.supplai.com' }],
    ...
    candidates: [
      {
        ...
        thumb: 'conduit',
        badge: { label: 'Exact match', tone: 'green' },
        engine: engine('Matching engine · catalog + past orders'),
        uom: 'FT',
        avail: 1840,
        qty: 400,
        unitPrice: 1.42,
      },
      {
        ...
        thumb: 'conduit',
        badge: { label: 'Close match', tone: 'amber' },
        engine: engine('Matching engine · catalog'),
        uom: 'FT',
        avail: 620,
        qty: 400,
        unitPrice: 1.38,
      },
      {
        ...
        thumb: 'conduit',
        badge: { label: 'Alternate', tone: 'slate' },
        engine: engine('Matching engine · substitution rules'),
        uom: 'FT',
        avail: 310,
        qty: 400,
        unitPrice: 2.61,
      },
      {
        ...
        thumb: 'conduit',
        badge: { label: 'Alternate', tone: 'slate' },
        engine: engine('Matching engine · house brand swap'),
        uom: 'FT',
        avail: 2400,
        qty: 400,
        unitPrice: 1.19,
      },
      {
        ...
        thumb: 'conduit',
        badge: { label: 'Different material', tone: 'red' },
        engine: engine('Matching engine · category sibling'),
        uom: 'FT',
        avail: 980,
        qty: 400,
        unitPrice: 3.04,
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        thumb: 'wire',
        badge: { label: 'Close match', tone: 'amber' },
        engine: engine('Matching engine · packaging variant'),
        uom: 'FT',
        avail: 12000,
        qty: 2500,
        unitPrice: 0.36,
      },
      {
        ...
        thumb: 'wire',
        badge: { label: 'Different construction', tone: 'red' },
        engine: engine('Matching engine · category sibling'),
        uom: 'FT',
        avail: 4000,
        qty: 2500,
    ...
    candidates: [
      {
        ...
        thumb: 'box',
        badge: { label: 'Likely match', tone: 'amber' },
        engine: engine('Matching engine · catalog'),
        uom: 'EA',
        avail: 240,
        qty: 45,
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        thumb: 'strut',
        badge: { label: 'Close match', tone: 'amber' },
        engine: engine('Matching engine · finish variant'),
        uom: 'FT',
        avail: 300,
        qty: 240,
        unitPrice: 5.44,
    ...
    candidates: [
      {
        ...
        thumb: 'clamp',
        badge: { label: 'Needs review', tone: 'red' },
        engine: engine('Matching engine · low confidence'),
        uom: 'EA',
        avail: 74,
        qty: 150,
        unitPrice: 2.31,
  ...
  'li-4': [
    {
      ...
      thumb: 'box',
      badge: { label: 'Alternate', tone: 'slate' },
      engine: 'Matching engine · category sibling',
      uom: 'EA',
      avail: 320,
      qty: 45,
      unitPrice: 3.44,
    },
    {
      ...
      thumb: 'box',
      badge: { label: 'Different depth', tone: 'red' },
      engine: 'Matching engine · category sibling',
      uom: 'EA',
      avail: 610,
      qty: 45,
    ...
    },
    {
      ...
      thumb: 'box',
      badge: { label: 'Alternate', tone: 'slate' },
      engine: 'Matching engine · substitution rules',
      uom: 'EA',
      avail: 46,
      qty: 45,
      unitPrice: 5.11,
    },
    {
      ...
      thumb: 'box',
      badge: { label: 'Alternate', tone: 'slate' },
      engine: 'Matching engine · special order',
      uom: 'EA',
      avail: 0,
      qty: 45,
      unitPrice: 19.4,
  ...
  'li-6': [
    {
      ...
      thumb: 'clamp',
      badge: { label: 'Alternate', tone: 'slate' },
      engine: 'Matching engine · finish variant',
      uom: 'EA',
      avail: 40,
      qty: 150,
      unitPrice: 7.9,
    ...
    },
    {
      ...
      thumb: 'clamp',
      badge: { label: 'Different item', tone: 'red' },
      engine: 'Matching engine · keyword only',
      uom: 'EA',
      avail: 880,
      qty: 150,
      unitPrice: 1.44,
